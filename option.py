...
parser.add_argument('--data_range', type=str, default='1-32/801-810', 
...
parser.add_argument('--w_bits', type=int, default=32,
                    help='The w_bits of the quantzie')
parser.add_argument('--a_bits', type=int, default=32,
                    help='The a_bits of the quantzie')

parser.add_argument('--calib_round', type=int, default=1,
                    help='The images of the calibration is (calib_round + 1) × batch_size')
parser.add_argument('--calib', action='store_true',
                    help='save or calibration')
...
parser.add_argument('--w_at', type=float, default=1000,
                    help='learning rate') 
parser.add_argument('--w_rg', type=float, default=1,
                    help='learning rate') 
